      ...
      <form className="admin-form" onSubmit={props.submitt} noValidate>
        <div className="form-header">
          ...
          <p className="form-subtitle">
            {props.editing ? 'Update your event details' : 'Track your daily activities'}
          </p>
        </div>
        ...
        <fieldset className="form-section">
          ...
          <div className="form-group">
            ...
            <div className="input-wrapper">
              <select
                ...
                onChange={e => { props.selectstate(e.target.value); props.clearError && props.clearError(""); }}
            ...
            <div id="category-help" className="form-help">Choose the type of activity</div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="input-wrapper">
              <textarea
                ...
                maxLength={500}
              />
              <div className="input-icon"><MdEdit /></div>
            </div>
            <div className="form-help">
              <span id="task-help">Be specific about your task</span>
              <span className="char-count">{props.content?.length || 0}/500</span>
            </div>
          </div>
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <div className="input-wrapper">
                ...
                />
                <div className="input-icon"><MdSchedule /></div>
              </div>
              <div id="start-help" className="form-help">When does this start?</div>
            </div>
            ...
            <div className="form-group">
              ...
              <div id="end-help" className="form-help">When does this end?</div>
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="duration-display">
              ...
              <div className="duration-icon"><MdTimer /></div>
            </div>
            <div className="form-help">Duration is calculated automatically</div>
          </div>
        </fieldset>
        ...
        <div className="form-actions">
          ...
          >
            {props.saving ? (
              ...
              <>
                <span className="button-icon">{props.editing ? <MdEdit /> : <MdAdd />}</span>
                {props.editing ? "Update Event" : "Add Event"}
              </>
            )}
          </button>
          <div id="submit-help" className="sr-only">
            {props.editing ? "Save your changes to the event" : "Add this event to your tracker"}
          </div>
        </div>
      </form>
    </div>
